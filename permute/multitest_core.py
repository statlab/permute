...
def multitest_two_sample_core(potential_outcomes_all, nx, tst_stat, alternative='greater',
    ...
    rr = list(range(potential_outcomes_all.shape[0])) # create indexing vect?
    tst = tst_stat(potential_outcomes_all[:nx,:,0], # get tst_stat of each paired outcome (difference control vs test condition)
...
""" start multitest version of 'stratified' """
