...
::
   ...
   git clone git://github.com/statlab/permute.git
...
Then, send the generated patch files to the `permute
...
#. Finally, make your commits into patches.  You want all the
   ...
   Send these files to the `permute mailing list`_.
...
Fork the `permute`_ repository on github |emdash| :ref:`forking`.
Then::
   ...
   git remote add origin git@github.com:your-user-name/permute.git
