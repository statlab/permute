...
require(combinat)
U<-combn(2*n,n)
ind.perm<-apply(U,2,function(x){c(c(1:(2*n))[x],c(1:(2*n))[-x])})
...
return(list(pa=pa,pb=pb,pab=pab,pab.a=pab.a,pab.b=pab.b,TA=T.A[1],TB=T.B[1],TAB.a=T.AB.a[1],TAB.b=T.AB.b[1],type="Constrained",
